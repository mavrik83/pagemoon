            ...
            >
                <div className='relative'>
                    ...
                    <Transition
                        ...
                        leaveTo='opacity-0'
                    >
                        <Combobox.Options className='absolute z-50 mt-1 max-h-60 w-fit min-w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm'>
                            {creatable &&
                                query.length >= 3 &&
                                !options.some((option) =>
                                    option.name
